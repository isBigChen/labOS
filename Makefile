...
LIBS = main.o screen.o mem.o picirq.o disk.o init.o kbd.o int_handlers.o task.o sys_call.o
USER_OBJS = user.o user_lib.o
...
$(USER_BIN): $(foreach dir,$(USER_OBJS),$(OBJ_DIR)/$(dir))
	$(V)mkdir -p $(@D)
...
# boot.s: sector 0
# setup.s: sector 1
# kernel binary: sector 2-31
# user programs: start from sector 32
$(OSIMG): $(BOOT_BIN) $(SETUP_BIN) $(KERNEL_BIN) $(USER_BIN)
	...
	$(V)dd if=$(USER_BIN) of=$@ seek=32 conv=notrunc
